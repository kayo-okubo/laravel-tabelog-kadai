<nav class="navbar navbar-expand-md navbar-light shadow-sm tabelog-header-container">
  <div class="container">
    ...
    <form action="{{ route('shops.index') }}" method="GET" class="row g-1">
      ...
      <div class="col-auto">
        <button type="submit" class="btn-tabelog-header-search-button">
          <i class="fas fa-search tabelog-header-search-icon"></i></button>
      </div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mr-5 mt-2">
        ...
        <li class="nav-item mr-5">
          <a class="nav-link" href="{{ route('reservations.index') }}"><i class="far fa-calendar-days"></i></a>
        </li>
